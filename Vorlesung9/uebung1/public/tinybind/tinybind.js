(function (global, factory) {
    ...
    var Binding =
      ...
      (function () {
        ...
        _proto.parseFormatterArguments = function parseFormatterArguments(
          args,
          formatterIndex
        ) {
          var _this = this;
        ...
        _proto.publish = function publish() {
          ...
          if (this.observer) {
            var value = this.formatters.reduceRight(function (
              result,
              declaration,
              index
            ) {
    ...
    var View =
      ...
      (function () {
        ...
        _proto.buildBinding = function buildBinding(
          node,
          type,
          declaration,
          binder,
          ...
          this.bindings.push(
            new Binding(this, node, type, keypath, binder, arg, pipes)
          );
            ...
            if (attribute.name.indexOf(bindingPrefix) === 0) {
              ...
              if (!binder) {
                for (var k = 0; k < starBinders.length; k++) {
                  ...
                  if (
                    type.slice(0, identifier.length - 1) ===
        ...
        routine: function routine(el, collection) {
            ...
            if (!view) {
              ...
              if (view.models[modelName] !== model) {
                ...
                for (
                  ...
                  nextIndex < _this.iterated.length;
                  nextIndex++
                ) {
                ...
                if (matchIndex !== undefined) {
                  ...
                  _this.marker.parentNode.insertBefore(
                    nextView.els[0],
                    view.els[0]
                  );
          ...
          if (el.nodeName === "OPTION") {
            this.view.bindings.forEach(function (binding) {
              if (
                binding.el === _this.marker.parentNode &&
                binding.type === "value"
              ) {
                binding.sync();
              }
        ...
        bind: function bind(el) {
          if (!this.marker) {
            this.marker = document.createComment(
              " tinybind: " + this.type + " " + this.keypath + " "
            );
            this.attached = false;
            el.parentNode.insertBefore(this.marker, el);
            el.parentNode.removeChild(el);
            ...
            get: function get() {
              ...
              if (properties) {
                Object.keys(properties).forEach(function (propName) {
                  ...
                  var attrName =
                    typeof propConfig === "string" ? propConfig : propName;
    ...
    tinybind.bind = function (el, models, options) {
      ...
      viewOptions.starBinders = Object.keys(viewOptions.binders).filter(function (
        key
      ) {
